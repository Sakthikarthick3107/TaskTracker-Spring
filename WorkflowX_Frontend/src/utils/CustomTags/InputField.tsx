...
const InputField: React.FC<InputType> = ({ type, placeholder = "Enter any...", name, value, onChange , className }) => {
    ...
    return (
        <div className="relative">
            {type === 'textarea' ? (
                <textarea
                    className={`${className} w-full outline-none bg-transparent border border-primary p-2 my-2 resize-none rounded-md`}
