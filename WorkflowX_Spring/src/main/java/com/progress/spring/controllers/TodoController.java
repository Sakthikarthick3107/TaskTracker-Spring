...
public class TodoController {
    ...
    @Operation(summary = "Project - All Tasks")
    ...
    public List<Todo> filterProjectTasks(@PathVariable String projectId,@RequestParam(required = false) String priority , @RequestParam(required = false) String taskName){
